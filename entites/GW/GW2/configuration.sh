...
echo "--------------------------------" >> /home/neuaa/ProjetLong/simulation/opensand-docker/output
echo >> /home/neuaa/ProjetLong/simulation/opensand-docker/output
echo "- satellite gateway 2 - ${gw_id}" >> /home/neuaa/ProjetLong/simulation/opensand-docker/output
...
docker create -it --privileged -v /home/neuaa/ProjetLong/simulation/opensand-docker/entites/GW/GW2/daemonbck${simulation_id}.conf:/etc/opensand/daemonbck.conf --net opensand-network-${simulation_id} --ip $gw_sat_addr  --hostname gw2-${simulation_id} --name gw2-${simulation_id} opensand-daemon
